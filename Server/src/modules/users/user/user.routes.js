...
import {
  ...
  getAcademicos, getAcademicoFullProfileHandler, updateAcademicoProfileHandler,
  getRoles, getRolesAcademico,
...
router.get('/academicos/:id/perfil',
  auth, authorizeRoles('Admin', 'Secretaria', 'Academico'),
  getAcademicoFullProfileHandler
);
router.put('/academicos/:id/perfil',
  auth, authorizeRoles('Academico', 'Admin'),
