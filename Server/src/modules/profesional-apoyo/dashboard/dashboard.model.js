  ...
  const [rows] = await pool.query(`
    SELECT * FROM (
      SELECT u.usuario_id,
        ...
        ra.tipo_academico AS tipo_contrato, 'Publicaciones' AS modulo,
      ...
      SELECT u.usuario_id,
        CONCAT(u.primer_nombre, ' ', u.primer_apellido),
        ra.tipo_academico, 'Capítulos de Libro',
      ...
      SELECT u.usuario_id,
        CONCAT(u.primer_nombre, ' ', u.primer_apellido),
        ra.tipo_academico, 'Investigación',
      ...
      SELECT u.usuario_id,
        CONCAT(u.primer_nombre, ' ', u.primer_apellido),
        ra.tipo_academico, 'Proyectos de Intervención',
      ...
      SELECT u.usuario_id,
        CONCAT(u.primer_nombre, ' ', u.primer_apellido),
        ra.tipo_academico, 'Consultorías',
