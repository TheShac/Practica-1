      ...
      <div className="row g-3">
        ...
        <div className="col-12 col-md-4">
          ...
          <select
            ...
            value={form.rol_id !== "" && form.rol_id !== null && form.rol_id !== undefined ? String(form.rol_id) : ""}
            onChange={(e) => {
              const nuevoRol = e.target.value !== "" ? Number(e.target.value) : "";
              setForm((p) => ({ ...p, rol_id: nuevoRol, programas: nuevoRol === 3 ? p.programas : [] }));
            }}
          >
            <option value="">Seleccione...</option>
            {roles.map((r) => <option key={r.rol_id} value={String(r.rol_id)}>{r.nombre}</option>)}
          </select>
        </div>
