...
import EstadoSelect from "@/shared/components/forms/statusSelect/EstadoSelect";
...
import { getFichaAcademica, getAcademicos } from "@/features/profesional-apoyo/services/ficha.service.js";
import { getCategorias } from "@/shared/services/categorias.service.js";

// Libros
import { createLibroParaAcademico, updateLibroParaAcademico, deleteLibroParaAcademico }
  from "@/features/profesional-apoyo/services/produccion-cientifica/libros.service";

// Publicaciones
import { createPublicacionParaAcademico, updatePublicacionParaAcademico, deletePublicacionParaAcademico }
  from "@/features/profesional-apoyo/services/produccion-cientifica/publicaciones.service";

// Capítulos de libro
import { createCapLibroParaAcademico, updateCapLibroParaAcademico, deleteCapLibroParaAcademico }
  from "@/features/profesional-apoyo/services/produccion-cientifica/cap.libros.service";

// Tesis
import { createTesisParaAcademico, updateTesisParaAcademico, deleteTesisParaAcademico }
  from "@/features/profesional-apoyo/services/produccion-cientifica/tesis.service";

// Investigación
import { createInvestigacionParaAcademico, updateInvestigacionParaAcademico, deleteInvestigacionParaAcademico }
  from "@/features/profesional-apoyo/services/produccion-cientifica/investigacion.service";

// Patente
import { createPatenteParaAcademico, updatePatenteParaAcademico, deletePatenteParaAcademico }
  from "@/features/profesional-apoyo/services/produccion-cientifica/patente.service";

// Intervención
import { listIntervencionesDeAcademico, createIntervencionParaAcademico, updateIntervencionParaAcademico, deleteIntervencionParaAcademico }
  from "@/features/profesional-apoyo/services/produccion-cientifica/intervencion.service";

// Consultoría
import { createConsultoriaParaAcademico, updateConsultoriaParaAcademico, deleteConsultoriaParaAcademico }
  from "@/features/profesional-apoyo/services/produccion-cientifica/consultoria.service";
